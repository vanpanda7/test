var ScrollyVideo = function() {
  "use strict";
  var t, e, i = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}, s = {
      exports: {}
  };
  t = s,
  e = s.exports,
              ...
              for (i = n = 0; i < f.length && !d; )
                  if (d = f[i++].exec(t))
                      for (o = 0; o < u.length; o++)
                          l = d[++n],
                          typeof (h = u[o]) === a && h.length > 0 ? 2 === h.length ? typeof h[1] == r ? this[h[0]] = h[1].call(this, l) : this[h[0]] = h[1] : 3 === h.length ? typeof h[1] !== r || h[1].exec && h[1].test ? this[h[0]] = l ? l.replace(h[1], h[2]) : s : this[h[0]] = l ? h[1].call(this, l, h[2]) : s : 4 === h.length && (this[h[0]] = l ? h[3].call(this, l.replace(h[1], h[2])) : s) : this[h] = l || s;
              p += 2
          }
      }
        , Y = function(t, e) {
        ...
        , W = function(t, e) {
          ...
          var r = t || (typeof i !== n && i.navigator && i.navigator.userAgent ? i.navigator.userAgent : "")
            , c = e ? function(t, e) {
              var i = {};
              for (var s in t)
                  e[s] && e[s].length % 2 == 0 ? i[s] = e[s].concat(t[s]) : i[s] = t[s];
              return i
          }(q, e) : q;
          return this.getBrowser = function() {
              ...
              e.major = typeof (t = e.version) === o ? t.replace(/[^\d\.]/g, "").split(".")[0] : s,
              e
          }
          ,
          ...
          this.setUA = function(t) {
              return r = typeof t === o && t.length > 350 ? H(t, 350) : t,
              this
          }
          ,
          this.setUA(r),
  ...
  var r = s.exports
    , n = {};
  !function(t) {
      var e, i, s, r = (e = new Date,
      i = 4,
      s = {
          setLogLevel: function(t) {
              i = t == this.debug ? 1 : t == this.info ? 2 : t == this.warn ? 3 : (this.error,
              4)
          },
          debug: function(t, s) {
              void 0 === console.debug && (console.debug = console.log),
              1 >= i && console.debug("[" + r.getDurationString(new Date - e, 1e3) + "]", "[" + t + "]", s)
          },
          log: function(t, e) {
              this.debug(t.msg)
          },
          info: function(t, s) {
              2 >= i && console.info("[" + r.getDurationString(new Date - e, 1e3) + "]", "[" + t + "]", s)
          },
          warn: function(t, s) {
              3 >= i && console.warn("[" + r.getDurationString(new Date - e, 1e3) + "]", "[" + t + "]", s)
          },
          error: function(t, s) {
              4 >= i && console.error("[" + r.getDurationString(new Date - e, 1e3) + "]", "[" + t + "]", s)
          }
      },
      s);
      ...
      n.prototype.seek = function(t) {
          ...
          return this.position = isNaN(e) || !isFinite(e) ? 0 : e,
          !0
      }
      ,
      ...
      var a = function(t, e, i) {
          ...
          t instanceof ArrayBuffer ? this.buffer = t : "object" == typeof t ? (this.dataView = t,
          e && (this._byteOffset += e)) : this.buffer = new ArrayBuffer(t || 0),
          this.position = 0,
      ...
      a.prototype.readInt32Array = function(t, e) {
          ...
          return a.memcpy(i.buffer, 0, this.buffer, this.byteOffset + this.position, t * i.BYTES_PER_ELEMENT),
      ...
      a.prototype.readInt8Array = function(t) {
          ...
          return a.memcpy(e.buffer, 0, this.buffer, this.byteOffset + this.position, t * e.BYTES_PER_ELEMENT),
      ...
      a.flipArrayEndianness = function(t) {
          for (var e = new Uint8Array(t.buffer,t.byteOffset,t.byteLength), i = 0; i < t.byteLength; i += t.BYTES_PER_ELEMENT)
              for (var s = i + t.BYTES_PER_ELEMENT - 1, r = i; s > r; s--,
              r++) {
                  var n = e[r];
                  e[r] = e[s],
                  e[s] = n
      ...
      a.prototype.readCString = function(t) {
          ...
          return null != t ? this.position += s - r : r != e && (this.position += 1),
          n
      }
      ;
      var o = Math.pow(2, 32);
      ...
      a.prototype.writeType = function(t, e, i) {
          ...
          var r = null
            , n = "ASCII"
            , o = this.position;
          switch ("string" == typeof t && /:/.test(t) && (s = t.split(":"),
          t = s[0],
          r = parseInt(s[1])),
          "string" == typeof t && /,/.test(t) && (s = t.split(","),
          t = s[0],
          n = parseInt(s[1])),
          t) {
          case "uint8":
      ...
      a.prototype.mapInt32Array = function(t, e) {
          ...
          return a.arrayToNative(i, null == e ? this.endianness : e),
          this.position += 4 * t,
          i
      }
      ,
      ...
      var h = function(t) {
          this.buffers = [],
          this.bufferIndex = -1,
          t && (this.insertBuffer(t),
          this.bufferIndex = 0)
      };
      (h.prototype = new a(new ArrayBuffer,0,a.BIG_ENDIAN)).initialized = function() {
          var t;
          return this.bufferIndex > -1 || (this.buffers.length > 0 ? 0 === (t = this.buffers[0]).fileStart ? (this.buffer = t,
          this.bufferIndex = 0,
          r.debug("MultiBufferStream", "Stream ready for parsing"),
          !0) : (r.warn("MultiBufferStream", "The first buffer should have a fileStart of 0"),
          this.logBufferLevel(),
          !1) : (r.warn("MultiBufferStream", "No buffer to start parsing from"),
          this.logBufferLevel(),
          !1))
      }
      ,
      ...
      h.prototype.reduceBuffer = function(t, e, i) {
          var s;
          return (s = new Uint8Array(i)).set(new Uint8Array(t,e,i)),
      ...
      h.prototype.insertBuffer = function(t) {
          ...
          e && (r.debug("MultiBufferStream", "Appending new buffer (fileStart: " + t.fileStart + " - Length: " + t.byteLength + ")"),
          this.buffers.push(t),
          0 === i && (this.buffer = t))
      }
      ,
      h.prototype.logBufferLevel = function(t) {
          ...
          e = 0; e < this.buffers.length; e++)
              ...
              h += "[" + a.start + "-") : a.end === i.fileStart ? a.end = i.fileStart + i.byteLength : ((a = {}).start = i.fileStart,
      ...
      h.prototype.cleanBuffers = function() {
          ...
          for (t = 0; t < this.buffers.length; t++)
              (e = this.buffers[t]).usedBytes === e.byteLength && (r.debug("MultiBufferStream", "Removing buffer #" + t),
      ...
      h.prototype.findPosition = function(t, e, i) {
          var s, n = null, a = -1;
          for (s = !0 === t ? 0 : this.bufferIndex; s < this.buffers.length && (n = this.buffers[s]).fileStart <= e; )
              a = s,
              i && (n.fileStart + n.byteLength <= e ? n.usedBytes = n.byteLength : n.usedBytes = e - n.fileStart,
              this.logBufferLevel()),
              s++;
          return -1 !== a && (n = this.buffers[a]).fileStart + n.byteLength >= e ? (r.debug("MultiBufferStream", "Found position in existing buffer #" + a),
          a) : -1
      }
      ,
      h.prototype.findEndContiguousBuf = function(t) {
          ...
          if (i = this.buffers[r],
          this.buffers.length > r + 1)
              for (e = r + 1; e < this.buffers.length && (s = this.buffers[e]).fileStart === i.fileStart + i.byteLength; e++)
                  i = s;
      ...
      h.prototype.seek = function(t, e, i) {
          var s;
          return -1 !== (s = this.findPosition(e, t, i)) ? (this.buffer = this.buffers[s],
          this.bufferIndex = s,
          this.position = t - this.buffer.fileStart,
          r.debug("MultiBufferStream", "Repositioning parser at buffer position: " + this.position),
          !0) : (r.debug("MultiBufferStream", "Position " + t + " not found in buffered data"),
          !1)
      }
      ,
      ...
      var d = function() {
          ...
          i.ES_Descriptor.prototype.parse = function(t) {
              if (this.ES_ID = t.readUint16(),
              this.flags = t.readUint8(),
              this.size -= 3,
              128 & this.flags ? (this.dependsOn_ES_ID = t.readUint16(),
              ...
              64 & this.flags) {
                  ...
                  this.URL = "";
              32 & this.flags ? (this.OCR_ES_ID = t.readUint16(),
          ...
          i.ES_Descriptor.prototype.getAudioConfig = function(t) {
              ...
              if (i && i.data) {
                  ...
                  return 31 === s && i.data.length >= 2 && (s = 32 + ((7 & i.data[0]) << 3) + ((224 & i.data[1]) >> 5)),
                  s
              }
              return null
          }
      ...
      l.parseOneBox = function(t, e, i) {
          var s, n, a, o = t.getPosition(), h = 0;
          if (t.getEndPosition() - o < 8)
              return r.debug("BoxParser", "Not enough data in stream to parse the type and size of the box"),
              {
                  code: l.ERR_NOT_ENOUGH_DATA
              };
          if (i && i < 8)
              return r.debug("BoxParser", "Not enough bytes left in the parent box to parse a new box"),
              {
                  code: l.ERR_NOT_ENOUGH_DATA
              };
          var d = t.readUint32()
            , p = t.readString(4)
            , f = p;
          if (r.debug("BoxParser", "Found box of type '" + p + "' and size " + d + " at position " + o),
          h = 8,
          "uuid" == p) {
          ...
          if (1 == d) {
              ...
              if (i)
                  ...
                  return r.error("BoxParser", "Unlimited box size not supported for type: '" + p + "'"),
                  s = new l.Box(p,d),
                  {
                      code: l.OK,
                      box: s,
          ...
          return d < h ? (r.error("BoxParser", "Box of type " + p + " has an invalid size " + d + " (too small to be a box)"),
          {
              code: l.ERR_NOT_ENOUGH_DATA,
              type: p,
              size: d,
              hdr_size: h,
              start: o
          }) : i && d > i ? (r.error("BoxParser", "Box of type '" + p + "' has a size " + d + " greater than its container size " + i),
          {
              code: l.ERR_NOT_ENOUGH_DATA,
              type: p,
              size: d,
          ...
          r.info("BoxParser", "Not enough data in stream to parse the entire '" + p + "' box"),
          {
              ...
              hdr_size: h,
              start: o
          } : (l[p + "Box"] ? s = new l[p + "Box"](d) : "uuid" !== p ? (r.warn("BoxParser", "Unknown box type: '" + p + "'"),
          (s = new l.Box(p,d)).has_unparsed_data = !0) : l.UUIDBoxes[a] ? s = new l.UUIDBoxes[a](d) : (r.warn("BoxParser", "Unknown uuid type: '" + a + "'"),
          (s = new l.Box(p,d)).uuid = a,
          s.has_unparsed_data = !0),
          s.hdr_size = h,
          s.start = o,
          s.write === l.Box.prototype.write && "mdat" !== s.type && (r.info("BoxParser", "'" + f + "' box writing not yet implemented, keeping unparsed data in memory for later write"),
          s.parseDataAndRewind(t)),
          s.parse(t),
          (n = t.getPosition() - (s.start + s.size)) < 0 ? (r.warn("BoxParser", "Parsing of box '" + f + "' did not read the entire indicated box data size (missing " + -n + " bytes), seeking forward"),
          t.seek(s.start + s.size)) : n > 0 && (r.error("BoxParser", "Parsing of box '" + f + "' read " + n + " more bytes than the indicated box data size, seeking backwards"),
      ...
      l.ContainerBox.prototype.parse = function(t) {
          for (var e, i; t.getPosition() < this.start + this.size; ) {
              if ((e = l.parseOneBox(t, !1, this.size - (t.getPosition() - this.start))).code !== l.OK)
                  return;
              if (i = e.box,
              this.boxes.push(i),
      ...
      l.createBoxCtor("avcC", (function(t) {
          var e, i;
          for (this.configurationVersion = t.readUint8(),
          ...
          for (this.nb_PPS_nalus = t.readUint8(),
          i--,
          this.PPS = [],
      ...
      l.createBoxCtor("colr", (function(t) {
          if (this.colour_type = t.readString(4),
          "nclx" === this.colour_type) {
              ...
              ("rICC" === this.colour_type || "prof" === this.colour_type) && (this.ICC_profile = t.readUint8Array(this.size - 4))
      }
      )),
      ...
      l.createFullBoxCtor("cslg", (function(t) {
          0 === this.version && (this.compositionToDTSShift = t.readInt32(),
      ...
      l.createFullBoxCtor("dfLa", (function(t) {
          ...
          for (this.parseFullHeader(t); ; ) {
              ...
              if (r ? t.readUint8Array(t.readUint24()) : (t.readUint8Array(13),
      ...
      l.createFullBoxCtor("elst", (function(t) {
          ...
          for (var e = t.readUint32(), i = 0; i < e; i++) {
              var s = {};
              this.entries.push(s),
              1 === this.version ? (s.segment_duration = t.readUint64(),
              s.media_time = t.readInt64()) : (s.segment_duration = t.readUint32(),
      ...
      l.createFullBoxCtor("iloc", (function(t) {
          ...
          for (var s = 0; s < i; s++) {
              ...
              switch (1 === this.version || 2 === this.version ? r.construction_method = 15 & t.readUint16() : r.construction_method = 0,
      ...
      l.createFullBoxCtor("infe", (function(t) {
          ...
          1 === this.version)
              return this.extension_type = t.readString(4),
              r.warn("BoxParser", "Cannot parse extension type"),
              void t.seek(this.start + this.size);
          this.version >= 2 && (2 === this.version ? this.item_ID = t.readUint16() : 3 === this.version && (this.item_ID = t.readUint32()),
          this.item_protection_index = t.readUint16(),
          this.item_type = t.readString(4),
          this.item_name = t.readCString(),
          "mime" === this.item_type ? (this.content_type = t.readCString(),
          this.content_encoding = t.readCString()) : "uri " === this.item_type && (this.item_uri_type = t.readCString()))
      }
      )),
      l.createFullBoxCtor("ipma", (function(t) {
          var e, i;
          for (entry_count = t.readUint32(),
          this.associations = [],
          e = 0; e < entry_count; e++) {
              var s = {};
      ...
      l.createFullBoxCtor("iref", (function(t) {
          ...
          for (this.references = []; t.getPosition() < this.start + this.size; ) {
              if ((e = l.parseOneBox(t, !0, this.size - (t.getPosition() - this.start))).code !== l.OK)
                  return;
              (i = 0 === this.version ? new l.SingleItemTypeReferenceBox(e.type,e.size,e.hdr_size,e.start) : new l.SingleItemTypeReferenceBoxLarge(e.type,e.size,e.hdr_size,e.start)).write === l.Box.prototype.write && "mdat" !== i.type && (r.warn("BoxParser", i.type + " box writing not yet implemented, keeping unparsed data in memory for later write"),
      ...
      l.createFullBoxCtor("mdhd", (function(t) {
          1 == this.version ? (this.creation_time = t.readUint64(),
          this.modification_time = t.readUint64(),
          this.timescale = t.readUint32(),
          this.duration = t.readUint64()) : (this.creation_time = t.readUint32(),
      ...
      l.createFullBoxCtor("mehd", (function(t) {
          1 & this.flags && (r.warn("BoxParser", "mehd box incorrectly uses flags set to 1, converting version to 1"),
          this.version = 1),
      ...
      l.createFullBoxCtor("pixi", (function(t) {
          var e;
          for (this.num_channels = t.readUint8(),
          this.bits_per_channels = [],
          e = 0; e < this.num_channels; e++)
      ...
      l.createFullBoxCtor("pssh", (function(t) {
          if (this.system_id = l.parseHex16(t),
          this.version > 0) {
              var e = t.readUint32();
              this.kid = [];
              for (var i = 0; i < e; i++)
                  this.kid[i] = l.parseHex16(t)
          }
          var s = t.readUint32();
      ...
      l.createFullBoxCtor("saio", (function(t) {
          1 & this.flags && (this.aux_info_type = t.readUint32(),
      ...
      l.createSampleGroupCtor("avss", (function(t) {
          ...
          this.avgRateFlag && (this.accurateStatisticsFlag = t.readUint8(),
          this.avgBitRate = t.readUint16(),
          this.avgFrameRate = t.readUint16()),
          this.dependency = [];
      ...
      l.createSampleGroupCtor("rash", (function(t) {
          if (this.operation_point_count = t.readUint16(),
      ...
      l.createSampleGroupCtor("seig", (function(t) {
          ...
          this.constant_IV = 0,
          1 === this.isProtected && 0 === this.Per_Sample_IV_Size && (this.constant_IV_size = t.readUint8(),
      ...
      l.createFullBoxCtor("sgpd", (function(t) {
          ...
          for (var e = t.readUint32(), i = 0; i < e; i++) {
              ...
              s.write === l.SampleGroupEntry.prototype.write && (r.info("BoxParser", "SampleGroup for type " + this.grouping_type + " writing not yet implemented, keeping unparsed data in memory for later write"),
      ...
      l.createFullBoxCtor("sidx", (function(t) {
          ...
          this.timescale = t.readUint32(),
          0 === this.version ? (this.earliest_presentation_time = t.readUint32(),
          this.first_offset = t.readUint32()) : (this.earliest_presentation_time = t.readUint64(),
      ...
      l.createFullBoxCtor("stsd", (function(t) {
          ...
          s = t.readUint32(),
          e = 1; e <= s; e++) {
              if ((i = l.parseOneBox(t, !0, this.size - (t.getPosition() - this.start))).code !== l.OK)
                  return;
              l[i.type + "SampleEntry"] ? ((n = new l[i.type + "SampleEntry"](i.size)).hdr_size = i.hdr_size,
              n.start = i.start) : (r.warn("BoxParser", "Unknown sample entry type: " + i.type),
              n = new l.SampleEntry(i.type,i.size,i.hdr_size,i.start)),
              n.write === l.SampleEntry.prototype.write && (r.info("BoxParser", "SampleEntry " + n.type + " box writing not yet implemented, keeping unparsed data in memory for later write"),
      ...
      l.createFullBoxCtor("stsz", (function(t) {
          ...
          0 === this.version)
              for (this.sample_size = t.readUint32(),
              this.sample_count = t.readUint32(),
              e = 0; e < this.sample_count; e++)
      ...
      l.createFullBoxCtor("stts", (function(t) {
          ...
          0 === this.version)
              for (i = 0; i < e; i++)
                  this.sample_counts.push(t.readUint32()),
                  (s = t.readInt32()) < 0 && (r.warn("BoxParser", "File uses negative stts sample delta, using value 1 instead, sync may be lost!"),
                  s = 1),
      ...
      l.createFullBoxCtor("stvi", (function(t) {
          ...
          for (this.stereo_indication_type = t.readString(r),
          this.boxes = []; t.getPosition() < this.start + this.size; ) {
              if ((i = l.parseOneBox(t, !1, this.size - (t.getPosition() - this.start))).code !== l.OK)
                  return;
              s = i.box,
              this.boxes.push(s),
              this[s.type] = s
      ...
      l.createFullBoxCtor("tenc", (function(t) {
          ...
          1 === this.default_isProtected && 0 === this.default_Per_Sample_IV_Size && (this.default_constant_IV_size = t.readUint8(),
      ...
      l.createFullBoxCtor("tfhd", (function(t) {
          ...
          this.size - this.hdr_size > e && this.flags & l.TFHD_FLAG_BASE_DATA_OFFSET ? (this.base_data_offset = t.readUint64(),
          e += 8) : this.base_data_offset = 0,
          this.size - this.hdr_size > e && this.flags & l.TFHD_FLAG_SAMPLE_DESC ? (this.default_sample_description_index = t.readUint32(),
          e += 4) : this.default_sample_description_index = 0,
          this.size - this.hdr_size > e && this.flags & l.TFHD_FLAG_SAMPLE_DUR ? (this.default_sample_duration = t.readUint32(),
          e += 4) : this.default_sample_duration = 0,
          this.size - this.hdr_size > e && this.flags & l.TFHD_FLAG_SAMPLE_SIZE ? (this.default_sample_size = t.readUint32(),
          e += 4) : this.default_sample_size = 0,
          this.size - this.hdr_size > e && this.flags & l.TFHD_FLAG_SAMPLE_FLAGS ? (this.default_sample_flags = t.readUint32(),
          e += 4) : this.default_sample_flags = 0
      }
      )),
      l.createFullBoxCtor("tfra", (function(t) {
          ...
          for (var i = t.readUint32(), s = 0; s < i; s++)
              1 === this.version ? (this.time = t.readUint64(),
              this.moof_offset = t.readUint64()) : (this.time = t.readUint32(),
      ...
      l.trefBox.prototype.parse = function(t) {
          for (var e, i; t.getPosition() < this.start + this.size; ) {
              if ((e = l.parseOneBox(t, !0, this.size - (t.getPosition() - this.start))).code !== l.OK)
                  return;
              (i = new l.TrackReferenceTypeBox(e.type,e.size,e.hdr_size,e.start)).write === l.Box.prototype.write && "mdat" !== i.type && (r.info("BoxParser", "TrackReference " + i.type + " box writing not yet implemented, keeping unparsed data in memory for later write"),
              i.parseDataAndRewind(t)),
              i.parse(t),
              this.boxes.push(i)
          }
      ...
      l.createFullBoxCtor("trep", (function(t) {
          for (this.track_ID = t.readUint32(),
          this.boxes = []; t.getPosition() < this.start + this.size; ) {
              if (ret = l.parseOneBox(t, !1, this.size - (t.getPosition() - this.start)),
              ret.code !== l.OK)
                  return;
              box = ret.box,
              this.boxes.push(box)
      ...
      l.createFullBoxCtor("trun", (function(t) {
          var e = 0;
          if (this.sample_count = t.readUint32(),
          e += 4,
          this.size - this.hdr_size > e && this.flags & l.TRUN_FLAGS_DATA_OFFSET ? (this.data_offset = t.readInt32(),
          e += 4) : this.data_offset = 0,
          this.size - this.hdr_size > e && this.flags & l.TRUN_FLAGS_FIRST_FLAG ? (this.first_sample_flags = t.readUint32(),
          e += 4) : this.first_sample_flags = 0,
      ...
      l.createUUIDBox("d4807ef2ca3946958e5426cb9e46a79f", !0, !1, (function(t) {
          ...
          for (var e = 0; e < this.fragment_count; e++) {
              var i = {}
                , s = 0
                , r = 0;
              1 === this.version ? (s = t.readUint64(),
              r = t.readUint64()) : (s = t.readUint32(),
              r = t.readUint32()),
              i.absolute_time = s,
      ...
      l.createUUIDBox("6d1d9b0542d544e680e2141daff757b2", !0, !1, (function(t) {
          1 === this.version ? (this.absolute_time = t.readUint64(),
          this.duration = t.readUint64()) : (this.absolute_time = t.readUint32(),
          this.duration = t.readUint32())
      }
      )),
      ...
      l.createFullBoxCtor("vpcC", (function(t) {
          var e;
          1 === this.version ? (this.profile = t.readUint8(),
          ...
          this.codecIntializationData = t.readUint8Array(this.codecIntializationDataSize)) : (this.profile = t.readUint8(),
          this.level = t.readUint8(),
          e = t.readUint8(),
      ...
      l.hev1SampleEntry.prototype.getCodec = l.hvc1SampleEntry.prototype.getCodec = function() {
          ...
          if (this.hvcC) {
              ...
              var r = !1
                , n = "";
              for (t = 5; t >= 0; t--)
                  (this.hvcC.general_constraint_indicator[t] || r) && (n = "." + l.decimalToHex(this.hvcC.general_constraint_indicator[t], 0) + n,
                  r = !0);
              e += n
          }
          return e
      ...
      l.av01SampleEntry.prototype.getCodec = function() {
          var t, e = l.SampleEntry.prototype.getCodec.call(this);
          return 2 === this.av1C.seq_profile && 1 === this.av1C.high_bitdepth ? t = 1 === this.av1C.twelve_bit ? "12" : "10" : this.av1C.seq_profile <= 2 && (t = 1 === this.av1C.high_bitdepth ? "10" : "08"),
      ...
      l.Box.prototype.writeHeader = function(t, e) {
          ...
          this.size > o ? t.writeUint32(1) : (this.sizePosition = t.getPosition(),
      ...
      l.Box.prototype.write = function(t) {
          ...
          this.writeHeader(t),
          t.writeUint8Array(this.data)) : (this.size = this.data ? this.data.length : 0,
          this.writeHeader(t),
      ...
      l.ContainerBox.prototype.write = function(t) {
          ...
          for (var e = 0; e < this.boxes.length; e++)
              this.boxes[e] && (this.boxes[e].write(t),
      ...
      l.avcCBox.prototype.write = function(t) {
          ...
          for (t.writeUint8(this.PPS.length),
          e = 0; e < this.PPS.length; e++)
      ...
      l.co64Box.prototype.write = function(t) {
          ...
          e = 0; e < this.chunk_offsets.length; e++)
      ...
      l.cttsBox.prototype.write = function(t) {
          ...
          e = 0; e < this.sample_counts.length; e++)
      ...
      l.stscBox.prototype.write = function(t) {
          ...
          e = 0; e < this.first_chunk.length; e++)
      ...
      l.stshBox.prototype.write = function(t) {
          ...
          e = 0; e < this.shadowed_sample_numbers.length; e++)
      ...
      l.trunBox.prototype.write = function(t) {
          ...
          this.flags & l.TRUN_FLAGS_DATA_OFFSET && (this.data_offset_position = t.getPosition(),
      ...
      l.stscBox.prototype.unpack = function(t) {
          ...
          e = 0; e < this.first_chunk.length; e++)
              for (i = 0; i < (e + 1 < this.first_chunk.length ? this.first_chunk[e + 1] : 1 / 0); i++)
                  for (n++,
                  s = 0; s < this.samples_per_chunk[e]; s++) {
                      if (!t[r])
                          return;
      ...
      l.boxEqualFields = function(t, e) {
          ...
          var i;
          for (i in t)
              if (!(l.DIFF_BOXES_PROP_NAMES.indexOf(i) > -1 || t[i]instanceof l.Box || e[i]instanceof l.Box || void 0 === t[i] || void 0 === e[i] || "function" == typeof t[i] || "function" == typeof e[i] || t.subBoxNames && t.subBoxNames.indexOf(i.slice(0, 4)) > -1 || e.subBoxNames && e.subBoxNames.indexOf(i.slice(0, 4)) > -1 || "data" === i || "start" === i || "size" === i || "creation_time" === i || "modification_time" === i || l.DIFF_PRIMITIVE_ARRAY_PROP_NAMES.indexOf(i) > -1 || t[i] === e[i]))
                  return !1;
          return !0
      }
      ,
      l.boxEqual = function(t, e) {
          if (!l.boxEqualFields(t, e))
              return !1;
          for (var i = 0; i < l.DIFF_BOXES_PROP_NAMES.length; i++) {
              var s = l.DIFF_BOXES_PROP_NAMES[i];
              if (t[s] && e[s] && !l.boxEqual(t[s], e[s]))
                  return !1
          }
          return !0
      }
      ...
      u.prototype.parse = function() {
          ...
          if (!this.restoreParsePosition || this.restoreParsePosition())
              for (; ; ) {
                  ...
                  (t = l.parseOneBox(this.stream, false)).code === l.ERR_NOT_ENOUGH_DATA) {
                  ...
                  var i;
                  switch (i = "uuid" !== (e = t.box).type ? e.type : e.uuid,
                  this.boxes.push(e),
                  i) {
                  case "mdat":
                      this.mdats.push(e);
      ...
      u.prototype.checkBuffer = function(t) {
          ...
          return 0 === t.byteLength ? (r.warn("ISOFile", "Ignoring empty buffer (fileStart: " + t.fileStart + ")"),
          this.stream.logBufferLevel(),
          !1) : (r.info("ISOFile", "Processing buffer (fileStart: " + t.fileStart + ")"),
          t.usedBytes = 0,
          this.stream.insertBuffer(t),
          this.stream.logBufferLevel(),
          !!this.stream.initialized() || (r.warn("ISOFile", "Not ready to start parsing"),
          !1))
      }
      ,
      u.prototype.appendBuffer = function(t, e) {
          ...
          if (this.checkBuffer(t))
              ...
              this.stream.cleanBuffers && (r.info("ISOFile", "Done processing buffer (fileStart: " + t.fileStart + ") - next buffer to fetch should have a fileStart position of " + i),
              this.stream.logBufferLevel(),
      ...
      u.prototype.getInfo = function() {
          var t, e, i, s, r, n = {}, a = new Date("1904-01-01T00:00:00Z").getTime();
          if (this.moov)
              for (n.hasMoov = !0,
              ...
              t = 0; t < this.moov.traks.length; t++) {
                  if (r = (i = this.moov.traks[t]).mdia.minf.stbl.stsd.entries[0],
                  s = {},
                  n.tracks.push(s),
                  ...
                  r.isAudio() ? (s.type = "audio",
                  n.audioTracks.push(s),
                  s.audio = {},
                  s.audio.sample_rate = r.getSampleRate(),
                  s.audio.channel_count = r.getChannelCount(),
                  s.audio.sample_size = r.getSampleSize()) : r.isVideo() ? (s.type = "video",
                  n.videoTracks.push(s),
                  s.video = {},
                  s.video.width = r.getWidth(),
                  s.video.height = r.getHeight()) : r.isSubtitle() ? (s.type = "subtitles",
                  n.subtitleTracks.push(s)) : r.isHint() ? (s.type = "metadata",
                  n.hintTracks.push(s)) : r.isMetadata() ? (s.type = "metadata",
                  n.metadataTracks.push(s)) : (s.type = "metadata",
                  n.otherTracks.push(s))
              }
          else
              n.hasMoov = !1;
          if (n.mime = "",
          n.hasMoov && n.tracks) {
              for (n.videoTracks && n.videoTracks.length > 0 ? n.mime += 'video/mp4; codecs="' : n.audioTracks && n.audioTracks.length > 0 ? n.mime += 'audio/mp4; codecs="' : n.mime += 'application/mp4; codecs="',
              t = 0; t < n.tracks.length; t++)
                  0 !== t && (n.mime += ","),
              ...
              if (this.isFragmentationInitialized && null !== this.onSegment)
                  for (e = 0; e < this.fragmentedTracks.length; e++) {
                      ...
                      for (i = s.trak; i.nextSample < i.samples.length && this.sampleProcessingStarted; ) {
                          ...
                          if (!n)
                              break;
                          if (s.segmentStream = n,
                          i.nextSample++,
                          (i.nextSample % s.nb_samples == 0 || t || i.nextSample >= i.samples.length) && (r.info("ISOFile", "Sending fragmented data on track #" + s.id + " for samples [" + Math.max(0, i.nextSample - s.nb_samples) + "," + (i.nextSample - 1) + "]"),
                          r.info("ISOFile", "Sample data size in memory: " + this.getAllocatedSampleDataSize()),
              ...
              if (null !== this.onSamples)
                  for (e = 0; e < this.extractedTracks.length; e++) {
                      ...
                      for (i = a.trak; i.nextSample < i.samples.length && this.sampleProcessingStarted; ) {
                          ...
                          if (i.nextSample++,
                          a.samples.push(o),
                          (i.nextSample % a.nb_samples == 0 || i.nextSample >= i.samples.length) && (r.debug("ISOFile", "Sending samples on track #" + a.id + " for sample " + i.nextSample),
      ...
      u.prototype.getBoxes = function(t, e) {
          var i = [];
          return u._sweep.call(this, t, i, e),
          i
      }
      ,
      ...
      u.prototype.seekTrack = function(t, e, i) {
          ...
          if (0 === i.samples.length)
              return r.info("ISOFile", "No sample in track, cannot seek! Using time " + r.getDurationString(0, 1) + " and offset: 0"),
              {
                  offset: 0,
                  time: 0
              };
          ...
          i.nextSample = d; i.samples[d].alreadyRead === i.samples[d].size && i.samples[d + 1]; )
              d++;
          return a = i.samples[d].offset + i.samples[d].alreadyRead,
      ...
      u.prototype.seek = function(t, e) {
          ...
          if (this.moov) {
              ...
              return r.info("ISOFile", "Seeking at time " + r.getDurationString(o.time, 1) + " needs a buffer with a fileStart position of " + o.offset),
              o.offset === 1 / 0 ? o = {
      ...
      u.prototype.processIncompleteBox = function(t) {
          var e;
          return "mdat" === t.type ? (e = new l[t.type + "Box"](t.size),
          this.parsingMdat = e,
          this.boxes.push(e),
          this.mdats.push(e),
          e.start = t.start,
          ...
          this.stream.seek(e.start + e.size, !1, this.discardMdatData) ? (this.parsingMdat = null,
          !0) : (this.moovStartFound ? this.nextParsePosition = this.stream.findEndContiguousBuf() : this.nextParsePosition = e.start + e.size,
          !1)) : ("moov" === t.type && (this.moovStartFound = !0,
          0 === this.mdats.length && (this.isProgressive = !0)),
          !!this.stream.mergeNextBuffer && this.stream.mergeNextBuffer() ? (this.nextParsePosition = this.stream.getEndPosition(),
          !0) : (t.type ? this.moovStartFound ? this.nextParsePosition = this.stream.getEndPosition() : this.nextParsePosition = this.stream.getPosition() + t.size : this.nextParsePosition = this.stream.getEndPosition(),
          !1))
      }
      ,
      ...
      u.prototype.processIncompleteMdat = function() {
          ...
          this.stream.seek(t.start + t.size, !1, this.discardMdatData) ? (r.debug("ISOFile", "Found 'mdat' end in buffered data"),
      ...
      u.prototype.updateUsedBytes = function(t, e) {
          this.stream.addUsedBytes && ("mdat" === t.type ? (this.stream.addUsedBytes(t.hdr_size),
          this.discardMdatData && this.stream.addUsedBytes(t.size - t.hdr_size)) : this.stream.addUsedBytes(t.size))
      }
      ,
      ...
      u.prototype.init = function(t) {
          ...
          var i = this.add("moov");
          return i.add("mvhd").set("timescale", e.timescale || 600).set("rate", e.rate || 65536).set("creation_time", 0).set("modification_time", 0).set("duration", e.duration || 0).set("volume", e.width ? 0 : 256).set("matrix", [65536, 0, 0, 0, 65536, 0, 0, 0, 1073741824]).set("next_track_id", 1),
          i.add("mvex"),
          this
      }
      ,
      u.prototype.addTrack = function(t) {
          ...
          i.add("tkhd").set("flags", l.TKHD_FLAG_ENABLED | l.TKHD_FLAG_IN_MOVIE | l.TKHD_FLAG_IN_PREVIEW).set("creation_time", 0).set("modification_time", 0).set("track_id", e.id).set("duration", e.duration || 0).set("layer", e.layer || 0).set("alternate_group", 0).set("volume", 1).set("matrix", [0, 0, 0, 0, 0, 0, 0, 0, 0]).set("width", e.width).set("height", e.height);
          var s = i.add("mdia");
          ...
          if (void 0 !== l[e.type + "SampleEntry"]) {
              ...
              switch (o) {
              case "Visual":
                  if (r.add("vmhd").set("graphicsmode", 0).set("opcolor", [0, 0, 0]),
      ...
      u.prototype.createSingleSampleMoof = function(t) {
          ...
          return s.add("tfhd").set("track_id", t.track_id).set("flags", l.TFHD_FLAG_DEFAULT_BASE_IS_MOOF),
      ...
      u.prototype.resetTables = function() {
          ...
          t = 0; t < this.moov.traks.length; t++) {
              ...
              s.sample_deltas = [],
              (r = e.mdia.minf.stbl.ctts) && (r.sample_counts = [],
              r.sample_offsets = []),
      ...
      u.initSampleGroups = function(t, e, i, s, r) {
          ...
          for (e && (e.sample_groups_info = []),
          t.sample_groups_info || (t.sample_groups_info = []),
          a = 0; a < i.length; a++) {
              for (h = i[a].grouping_type + "/" + i[a].grouping_type_parameter,
              ...
              n = 0; n < s.length; n++)
                  s[n].grouping_type === i[a].grouping_type && (o.description = s[n],
                  o.description.used = !0);
              if (r)
                  for (n = 0; n < r.length; n++)
                      r[n].grouping_type === i[a].grouping_type && (o.fragment_description = r[n],
      ...
      u.setSampleGroupProperties = function(t, e, i, s) {
          ...
          s) {
              ...
              0 !== e.sample_groups[r].group_description_index)
                  ...
                  e.sample_groups[r].group_description_index > 0 ? (n = e.sample_groups[r].group_description_index > 65535 ? (e.sample_groups[r].group_description_index >> 16) - 1 : e.sample_groups[r].group_description_index - 1,
                  a && n >= 0 && (e.sample_groups[r].description = a.entries[n])) : a && a.version >= 2 && a.default_group_description_index > 0 && (e.sample_groups[r].description = a.entries[a.default_group_description_index - 1])
          }
      }
      ,
      u.process_sdtp = function(t, e, i) {
          e && (t ? (e.is_leading = t.is_leading[i],
          e.depends_on = t.sample_depends_on[i],
          e.is_depended_on = t.sample_is_depended_on[i],
          e.has_redundancy = t.sample_has_redundancy[i]) : (e.is_leading = 0,
          e.depends_on = 0,
          e.is_depended_on = 0,
          e.has_redundancy = 0))
      }
      ...
      u.prototype.buildTrakSampleLists = function(t) {
          var e, i, s, r, n, a, o, h, d, l, p, f, c, m, _, g, y, b, v, w, U, S, x, E;
          if (t.samples = [],
          ...
          void 0 !== r) {
              for (e = 0; e < r.sample_sizes.length; e++) {
                  ...
                  g = 0,
                  _ = c + 1 < s.first_chunk.length ? s.first_chunk[c + 1] - 1 : 1 / 0) : e < y ? (B.chunk_index = m,
                  B.chunk_run_index = c) : (m++,
                  B.chunk_index = m,
                  g = 0,
                  m <= _ || (_ = ++c + 1 < s.first_chunk.length ? s.first_chunk[c + 1] - 1 : 1 / 0),
                  B.chunk_run_index = c,
                  y += s.samples_per_chunk[c]),
                  ...
                  b < 0 && (b = 0),
                  b += n.sample_counts[v]),
                  e > 0 ? (t.samples[e - 1].duration = n.sample_deltas[v],
                  t.samples_duration += t.samples[e - 1].duration,
                  B.dts = t.samples[e - 1].dts + t.samples[e - 1].duration) : B.dts = 0,
                  a ? (e >= w && (U++,
                  w < 0 && (w = 0),
                  w += a.sample_counts[U]),
                  B.cts = t.samples[e].dts + a.sample_offsets[U]) : B.cts = B.dts,
                  o ? (e == o.sample_numbers[S] - 1 ? (B.is_sync = !0,
                  S++) : (B.is_sync = !1,
                  B.degradation_priority = 0),
                  d && d.entries[x].sample_delta + E == e + 1 && (B.subsamples = d.entries[x].subsamples,
                  E += d.entries[x].sample_delta,
                  x++)) : B.is_sync = !0,
                  u.process_sdtp(t.mdia.minf.stbl.sdtp, B, B.number),
                  B.degradation_priority = f ? f.priority[e] : 0,
                  d && d.entries[x].sample_delta + E == e && (B.subsamples = d.entries[x].subsamples,
                  E += d.entries[x].sample_delta),
                  (l.length > 0 || p.length > 0) && u.setSampleGroupProperties(t, B, e, t.sample_groups_info)
              }
              e > 0 && (t.samples[e - 1].duration = Math.max(t.mdia.mdhd.duration - t.samples[e - 1].dts, 0),
              t.samples_duration += t.samples[e - 1].duration)
          }
      }
      ,
      u.prototype.updateSampleLists = function() {
          ...
          if (void 0 !== this.moov)
              for (; this.lastMoofIndex < this.moofs.length; )
                  if (h = this.moofs[this.lastMoofIndex],
                  this.lastMoofIndex++,
                  "moof" == h.type)
                      for (d = h,
                      t = 0; t < d.trafs.length; t++) {
                          for (p = d.trafs[t],
                          f = this.getTrackById(p.tfhd.track_id),
                          c = this.getTrexById(p.tfhd.track_id),
                          s = p.tfhd.flags & l.TFHD_FLAG_SAMPLE_DESC ? p.tfhd.default_sample_description_index : c ? c.default_sample_description_index : 1,
                          r = p.tfhd.flags & l.TFHD_FLAG_SAMPLE_DUR ? p.tfhd.default_sample_duration : c ? c.default_sample_duration : 0,
                          n = p.tfhd.flags & l.TFHD_FLAG_SAMPLE_SIZE ? p.tfhd.default_sample_size : c ? c.default_sample_size : 0,
                          a = p.tfhd.flags & l.TFHD_FLAG_SAMPLE_FLAGS ? p.tfhd.default_sample_flags : c ? c.default_sample_flags : 0,
                          p.sample_number = 0,
                          p.sbgps.length > 0 && u.initSampleGroups(f, p, p.sbgps, f.mdia.minf.stbl.sgpds, p.sgpds),
                          e = 0; e < p.truns.length; e++) {
                              var g = p.truns[e];
                              for (i = 0; i < g.sample_count; i++) {
                                  ...
                                  m.description = f.mdia.minf.stbl.stsd.entries[m.description_index],
                                  m.size = n,
                                  g.flags & l.TRUN_FLAGS_SIZE && (m.size = g.sample_size[i]),
                                  f.samples_size += m.size,
                                  m.duration = r,
                                  g.flags & l.TRUN_FLAGS_DURATION && (m.duration = g.sample_duration[i]),
                                  f.samples_duration += m.duration,
                                  f.first_traf_merged || i > 0 ? m.dts = f.samples[f.samples.length - 2].dts + f.samples[f.samples.length - 2].duration : (p.tfdt ? m.dts = p.tfdt.baseMediaDecodeTime : m.dts = 0,
                                  f.first_traf_merged = !0),
                                  m.cts = m.dts,
                                  g.flags & l.TRUN_FLAGS_CTS_OFFSET && (m.cts = m.dts + g.sample_composition_time_offset[i]),
                                  _ = a,
                                  g.flags & l.TRUN_FLAGS_FLAGS ? _ = g.sample_flags[i] : 0 === i && g.flags & l.TRUN_FLAGS_FIRST_FLAG && (_ = g.first_sample_flags),
                                  m.is_sync = !(_ >> 16 & 1),
                                  m.is_leading = _ >> 26 & 3,
                                  m.depends_on = _ >> 24 & 3,
                                  ...
                                  var y = !!(p.tfhd.flags & l.TFHD_FLAG_BASE_DATA_OFFSET)
                                    ...
                                    , w = 0;
                                  w = y ? p.tfhd.base_data_offset : b || 0 === e ? d.start : o,
                                  m.offset = 0 === e && 0 === i ? v ? w + g.data_offset : w : o,
                                  o = m.offset + m.size,
                                  (p.sbgps.length > 0 || p.sgpds.length > 0 || f.mdia.minf.stbl.sbgps.length > 0 || f.mdia.minf.stbl.sgpds.length > 0) && u.setSampleGroupProperties(f, m, m.number_in_traf, p.sample_groups_info)
                              }
                          }
                          if (p.subs) {
                              f.has_fragment_subsamples = !0;
                              var U = p.first_sample_index;
                              for (e = 0; e < p.subs.entries.length; e++)
                                  U += p.subs.entries[e].sample_delta,
                                  (m = f.samples[U - 1]).subsamples = p.subs.entries[e].subsamples
                          }
                      }
      }
      ,
      u.prototype.getSample = function(t, e) {
          ...
          for (; ; ) {
              ...
              if (s.size - s.alreadyRead <= o)
                  return r.debug("ISOFile", "Getting sample #" + e + " data (alreadyRead: " + s.alreadyRead + " offset: " + (s.offset + s.alreadyRead - i.fileStart) + " read size: " + (s.size - s.alreadyRead) + " full size: " + s.size + ")"),
      ...
      u.prototype.flattenItemInfo = function() {
          var t, e, i, s = this.items, n = this.meta;
          if (null != n && void 0 !== n.hdlr && void 0 !== n.iinf) {
              ...
              if (n.iloc)
                  for (t = 0; t < n.iloc.items.length; t++) {
                      ...
                      switch (i = s[a.item_ID],
                      0 !== a.data_reference_index && (r.warn("Item storage with reference to other files: not supported"),
              ...
              if (n.pitm && (s[n.pitm.item_id].primary = !0),
              n.iref)
              ...
              if (n.iprp)
                  for (var h = 0; h < n.iprp.ipmas.length; h++) {
                      ...
                      for (t = 0; t < d.associations.length; t++) {
                          ...
                          for (void 0 === (i = s[l.id]).properties && (i.properties = {},
                          i.properties.boxes = []),
                          e = 0; e < l.props.length; e++) {
                              var p = l.props[e];
          ...
          for (var s = 0; s < i.extents.length; s++) {
              ...
              if (n.alreadyRead !== n.length) {
                  ...
                  if (!(n.length - n.alreadyRead <= h))
                      return r.debug("ISOFile", "Getting item #" + t + " extent #" + s + " partial data (alreadyRead: " + n.alreadyRead + " offset: " + (n.offset + n.alreadyRead - e.fileStart) + " read size: " + h + " full extent size: " + n.length + " full item size: " + i.size + ")"),
      ...
      u.prototype.itemToFragmentedTrackFile = function(t) {
          ...
          i.properties.ispe && (r.width = i.properties.ispe.image_width,
          r.height = i.properties.ispe.image_height);
          var n = s.addTrack(r);
          return n ? (s.addSample(n, i.data),
          s) : null
      }
      ,
      ...
      u.writeInitializationSegment = function(t, e, i, s) {
          ...
          t.write(o);
          var h = e.add("mvex");
          for (i && h.add("mehd").set("fragment_duration", i),
          n = 0; n < e.traks.length; n++)
              h.add("trex").set("track_id", e.traks[n].tkhd.track_id).set("default_sample_description_index", 1).set("default_sample_duration", s).set("default_sample_size", 0).set("default_sample_flags", 65536);
          return e.write(o),
          o.buffer
      }
      ,
      ...
      u.prototype.getBuffer = function() {
          var t = new a;
          return t.endianness = a.BIG_ENDIAN,
          this.write(t),
          t.buffer
      }
      ,
      u.prototype.initializeSegmentation = function() {
          var t, e, i, s;
          for (null === this.onSegment && r.warn("MP4Box", "No segmentation callback set!"),
          this.isFragmentationInitialized || (this.isFragmentationInitialized = !0,
          this.nextMoofNumber = 0,
          this.resetTables()),
          e = [],
          t = 0; t < this.fragmentedTracks.length; t++) {
              var n = new l.moovBox;
              ...
              s.buffer = u.writeInitializationSegment(this.ftyp, n, this.moov.mvex && this.moov.mvex.mehd ? this.moov.mvex.mehd.fragment_duration : void 0, this.moov.traks[t].samples.length > 0 ? this.moov.traks[t].samples[0].duration : 0),
              e.push(s)
          }
          return e
      }
  ...
  class a {
      ...
      writeUint16(t) {
          ...
          this.data.set([i[1], i[0]], this.idx),
          this.idx += 2
      }
      writeUint8Array(t) {
          this.data.set(t, this.idx),
  ...
  const o = (t,e,{VideoDecoder: i, EncodedVideoChunk: s, debug: r})=>new Promise(((o,h)=>{
          ...
          const p = new i({
              output: t=>{
                  createImageBitmap(t, {
                      ...
                      e(i),
                      t.close(),
                      p.decodeQueueSize <= 0 && setTimeout((()=>{
                          "closed" !== p.state && (p.close(),
                          o())
                      }
                      ), 500)
                  }
              ...
              if (t && t.videoTracks && t.videoTracks[0]) {
                  ...
                  const e = (t=>{
                      ...
                      for (e = 0; e < t.PPS.length; e += 1)
                          i += 2 + t.PPS[e].length;
                      const s = new a(i);
                      for (s.writeUint8(t.configurationVersion),
                      ...
                      e = 0; e < t.SPS.length; e += 1)
                          s.writeUint16(t.SPS[e].length),
                          s.writeUint8Array(t.SPS[e].nalu);
                      for (s.writeUint8(t.nb_PPS_nalus),
                      e = 0; e < t.PPS.length; e += 1)
                  ...
                  h(new Error("URL provided is not a valid mp4 video file."))
          }
          ,
          d.onSamples = (t,e,i)=>{
  ...
  return class {
      constructor({src: t, scrollyVideoContainer: e, cover: i=!0, sticky: s=!0, full: n=!0, trackScroll: a=!0, transitionSpeed: o=8, frameThreshold: h=.1, useWebCodecs: d=!0, debug: l=!1}) {
          if ("object" != typeof document)
              return void console.error("ScrollyVideo must be initiated in a DOM context");
          if (!e)
              return void console.error("scrollyVideoContainer must be a valid DOM object");
          if (!t)
              return void console.error("Must provide valid video src to ScrollyVideo");
          if (e instanceof Element)
              this.container = e;
          else {
              if ("string" != typeof e)
                  throw new Error("scrollyVideoContainer must be a valid DOM object");
              if (this.container = document.getElementById(e),
              !this.container)
                  throw new Error("scrollyVideoContainer must be a valid DOM object")
          }
          this.src = t,
          this.transitionSpeed = o,
          this.frameThreshold = h,
          this.useWebCodecs = d,
          this.cover = i,
          this.sticky = s,
          this.full = n,
          ...
          s && (this.container.style.display = "block",
          ...
          this.isSafari = "WebKit" === p.name,
          l && this.isSafari && console.info("Safari browser detected"),
          this.currentTime = 0,
          this.targetTime = 0,
          this.canvas = null,
          this.context = null,
      ...
      setCoverStyle(t) {
          if (this.cover) {
              ...
              e / i > s / r ? (t.style.width = "100%",
              t.style.height = "auto") : (t.style.height = "100%",
              t.style.width = "auto")
          }
      }
      decodeVideo() {
          var t, e, i;
          this.useWebCodecs && this.src && (t = this.src,
          e = t=>{
              this.frames.push(t)
          }
          ,
          i = this.debug,
          "function" == typeof VideoDecoder && "function" == typeof EncodedVideoChunk ? (i && console.info("WebCodecs is natively supported, using native version..."),
          o(t, e, {
              VideoDecoder: VideoDecoder,
              EncodedVideoChunk: EncodedVideoChunk,
              debug: i
          })) : (i && console.info("WebCodecs is not available in this browser."),
          Promise.resolve())).catch((()=>{
              ...
              0 !== this.frames.length ? (this.frameRate = this.frames.length / this.video.duration,
              ...
              this.paintCanvasFrame(Math.floor(this.currentTime * this.frameRate))) : this.debug && console.error("No frames were received from webCodecs")
          }
          ))
      }
      paintCanvasFrame(t) {
          if (this.canvas) {
              ...
              if (e) {
                  ...
                  i / s > e.width / e.height ? (this.canvas.style.width = "100%",
      ...
      transitionToTargetTime(t) {
          ...
          if (this.canvas)
              ...
              isNaN(t) || (this.video.playbackRate = t,
              this.video.play()),
      ...
      setTargetTimePercent(t, e) {
          ...
          !e && Math.abs(this.currentTime - this.targetTime) < this.frameThreshold || !e && this.transitioning || (this.canvas || this.video.play(),
